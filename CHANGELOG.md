...
- JSON replacement context: `report.contextChars` for values redacted by `jsonKeys` or
  `jsonKeyContains` now locates the quoted JSON value instead of the first bare
  substring.
